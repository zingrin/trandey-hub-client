    ...
    <div className="w-full px-4 md:px-10 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          {/* -------- ITEM 1 -------- */}
          <div className="relative bg-pink-100 rounded-lg shadow overflow-hidden">
            <img
              src="https://i.ibb.co/fYh2g9n/sneakers.png"
          ...
          {/* -------- ITEM 2 -------- */}
          <div className="relative bg-blue-100 rounded-lg shadow overflow-hidden">
            <img
              src="https://i.ibb.co/VWZjFjY/skirt.png"
              className="w-full object-cover"
            />
          ...
          {/* -------- ITEM 3 -------- */}
          <div className="relative bg-yellow-100 rounded-lg shadow overflow-hidden">
            <img
              src="https://i.ibb.co/NrcQ6hM/purse.png"
              className="w-full object-cover"
            />
          ...
          {/* -------- ITEM 4 -------- */}
          <div className="relative bg-purple-100 rounded-lg shadow overflow-hidden">
            <img
              src="https://i.ibb.co/Hxj0sCg/sunglass.png"
              className="w-full object-cover"
            />
          ...
          {/* -------- ITEM 5 (FULL WIDTH) -------- */}
          <div className="relative bg-green-100 rounded-lg shadow overflow-hidden col-span-2">
            <img
              src="https://i.ibb.co/2FxW0jz/toys.png"
              className="w-full object-cover"
            />
