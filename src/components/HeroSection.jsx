...
export default function HeroSection() {
  return (
    <div className="w-full relative -mt-10 md:-mt-14 lg:-mt-16">
      ...
      <div className="w-full h-[65vh] md:h-[80vh] lg:h-[95vh] overflow-hidden">
        ...
        <div id="slide1" className="carousel-item relative w-full">
          ...
          {/* TEXT BOX */}
          <div className="absolute left-4 md:left-12 lg:left-20 
          ...
          {/* ARROWS */}
          <a href="#slide3" className="absolute left-3 top-1/2 -translate-y-1/2 text-pink-400 text-3xl md:text-4xl">❮</a>
          <a href="#slide2" className="absolute right-3 top-1/2 -translate-y-1/2 text-pink-400 text-3xl md:text-4xl">❯</a>
        </div>
        ...
        <div id="slide2" className="carousel-item relative w-full">
          ...
          <div className="absolute left-4 md:left-12 lg:left-20 
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-light leading-tight">
              Meaningful <span className="text-pink-400">Accessories</span><br />
              For Every Moment
            </h1>
          ...
          <a href="#slide1" className="absolute left-3 top-1/2 -translate-y-1/2 text-pink-400 text-3xl md:text-4xl">❮</a>
          <a href="#slide3" className="absolute right-3 top-1/2 -translate-y-1/2 text-pink-400 text-3xl md:text-4xl">❯</a>
        </div>
        ...
        <div id="slide3" className="carousel-item relative w-full">
          ...
          <div className="absolute right-4 md:right-12 lg:right-20 
                          top-1/2 -translate-y-1/2 
          ...
          <a href="#slide2" className="absolute left-3 top-1/2 -translate-y-1/2 text-pink-400 text-3xl md:text-4xl">❮</a>
          <a href="#slide1" className="absolute right-3 top-1/2 -translate-y-1/2 text-pink-400 text-3xl md:text-4xl">❯</a>
        </div>
      </div>
